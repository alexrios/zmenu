...
/// Theme definition with 5 core colors
...
pub const frappe = Theme{
    ...
    .value_preview = .{ .r = 0x75, .g = 0x7c, .b = 0x93, .a = 0xff },
};
...
pub const macchiato = Theme{
    ...
    .value_preview = .{ .r = 0x79, .g = 0x7f, .b = 0x93, .a = 0xff },
};
...
pub const dracula = Theme{
    ...
    .value_preview = .{ .r = 0x6d, .g = 0x6f, .b = 0x7d, .a = 0xff },
};
...
pub const gruvbox = Theme{
    ...
    .value_preview = .{ .r = 0x92, .g = 0x83, .b = 0x74, .a = 0xff },
};
...
pub const nord = Theme{
    ...
    .value_preview = .{ .r = 0x4c, .g = 0x56, .b = 0x6a, .a = 0xff },
};
...
pub const solarized = Theme{
    ...
    .value_preview = .{ .r = 0x58, .g = 0x6e, .b = 0x75, .a = 0xff },
};
